...
FILENAME = '/home/lzt/Deep_Ocean/datasets/scaled.mat'#'E:\\Code\\DeepResNet_Ocean__\\DeepResNet_Ocean\\datasets\\scaled.mat'
VALNAME = 'data'

def load_data(valname=VALNAME, file=FILENAME):
    print('[+] loading data...')
...
def create_batch(num, channels, intervals, data=None):
    '''
    num: input size,
    '''
    if data is None:
